...
class _CreateProductViewState extends State<CreateProductView> {
  ...
  Column _createProductTextFields() {
    return Column(
      ...
      children: [
        ...
        TitledTextField(
            ...
            hintText: "Image URL",
            validator: (value) {
              if (value.isEmpty || !imageController.text.contains("http")) {
  ...
  Row _categorySection(BuildContext context) {
    return Row(
  ...
  Row _brandSection(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(
              ...
              onPressed: () {
                if (formKey.currentState!.validate()) {
                  if (selectedBrandId != null && selectedCategoryId != null) {
                    BlocProvider.of<DashboardCubit>(context).createProduct(
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        ...
                        content: const Text('Please select brand and category',
                            style: TextStyle(color: Colors.white)),
                        backgroundColor: Colors.red.shade800,
                      ),
                    );
